...
Item {
    ...
    Popup {
        ...
        parent: mainTab
        anchors.centerIn: parent
        width: Math.min(mainTab.width * 0.9, 320); height: 140
        modal: true
        focus: true
    ...
    Popup {
        ...
        parent: mainTab
        anchors.centerIn: parent
        width: Math.min(mainTab.width * 0.95, 380)
        height: modeCombo.currentText === "DMR" ? 380 : (modeCombo.currentText === "P25" || modeCombo.currentText === "NXDN" ? 340 : 300)
        modal: true
        focus: true
        ...
        Column {
            ...
            Column {
                ...
                Row {
                    width: parent.width
                    spacing: 10
                    Text { text: "Memory:"; color: "white"; font.pixelSize: 11; font.bold: true; width: 60; anchors.verticalCenter: parent.verticalCenter }
                    ComboBox {
                        id: slotSelector
                        width: 120; height: 28
                ...
                Row {
                    width: parent.width
                    spacing: 10
                    Text { text: "Mode:"; color: "white"; font.pixelSize: 11; font.bold: true; width: 60; anchors.verticalCenter: parent.verticalCenter }
                    ComboBox {
                        id: modeCombo
                        width: 120; height: 28
                        model: ["M17", "YSF", "FCS", "DMR", "P25", "NXDN", "REF", "XRF", "DCS", "IAX"]
                ...
                Row {
                    ...
                    Text { text: "Slot / CC:"; color: "white"; font.pixelSize: 11; font.bold: true; width: 60; anchors.verticalCenter: parent.verticalCenter }
                    ComboBox {
                        id: slotCombo
                        width: 80; height: 28
                        model: ["S1", "S2"]
                ...
                Row {
                    ...
                    Text { text: "TGID:"; color: "white"; font.pixelSize: 11; font.bold: true; width: 60; anchors.verticalCenter: parent.verticalCenter }
                    TextField {
                        id: tgidInput
                        width: 120; height: 28
                        color: "white"
