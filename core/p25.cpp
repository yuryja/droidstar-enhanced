...
void P25::on_network_read(const uint8_t* data, int len)
{
...
void P25::transmit()
{
	...
	if (m_audio) notify_output_level(m_audio->level() * 6);
	notify_update(m_modeinfo);
